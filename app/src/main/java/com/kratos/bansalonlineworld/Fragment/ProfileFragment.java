...
import com.kratos.bansalonlineworld.Adapter.FollowersAdapter;
...
import com.kratos.bansalonlineworld.databinding.FragmentProfileBinding;
        ...
        database.getReference().child("Users").child(auth.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    binding.userProfession.setText(user.getProfession());
        ...
        database.getReference().child("Users")
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    Follow follow = snapshot1.getValue(Follow.class);
                    list.add(follow);
                }
